...
export const projectItems = [
  ...
  },
  {
    ...
    description:
      'WebRTC 기반 양방향 차트 위 드로잉 화상 주식 상담 플랫폼',
  },
  {
    category: 'Project',
    title: 'Lin. Book',
    ...
    description:
      '모임통장을 활용한 투명한 관리가 쉬운 동아리 회계 플랫폼',
  },
  {
    category: 'Project',
    title: 'Insite',
  ...
  },
  {
    ...
    description:
      '사회와 단절된 삶의 희망을 연결하는 소아암 환아를 위한 휴머노이드 로봇',
  },
  {
    category: 'Project',
    ...
    skills: 'Figma',
    description:
      'SK Intellix의 A1 제품을 활용한 호텔 AI 상품 제안',
  },
  {
    category: 'Project',
...
export const skillGroups = [
  {
    title: 'Frontend',
    items: ['React', 'TypeScript', 'Vite', 'React Router', 'TailwindCSS'],
  },
  {
    title: 'UI Implementation',
    items: ['Responsive UI', 'Design System', 'Accessibility', 'Animation', 'Layout Design'],
  },
  {
    title: 'Workflow',
    items: ['Git', 'Figma Handoff', 'Component Architecture', 'State Management', 'Performance Tuning'],
  },
]
