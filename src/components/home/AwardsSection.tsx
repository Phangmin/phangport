function AwardsSection() {
  return (
    ...
    >
      ...
      <div
        data-home-contact-card="true"
        className="rounded-[24px] border border-slate-900/8 bg-white p-8 shadow-[0_18px_40px_rgba(15,23,42,0.06)]"
      >
        <p data-home-muted-text="true" className="m-0 max-w-[640px] leading-[1.8] text-slate-500">
