...
function SkillsSection() {
  return (
    ...
    >
      ...
      <article
        data-home-skills-card="true"
        className="grid gap-3 rounded-[20px] border border-slate-900/8 bg-white p-[22px] shadow-[0_18px_40px_rgba(15,23,42,0.06)]"
      >
